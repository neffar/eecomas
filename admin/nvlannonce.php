...
// if everything is ok, try to upload file
            ...
            if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                ...
                if (create($connection, "ANNONCE", $val_cols) !== false) {
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body col-lg-offset-3">
                            ...
                            <form action="nvlannonce.php" method="post" enctype="multipart/form-data">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <textarea name="annonce" class="form-control" required="" placeholder="Annonce"></textarea>
                                    </div>
