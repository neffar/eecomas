...
if (isset($_SESSION['id'])) {
    if (filter_input(INPUT_POST, 'submit')) {
        ...
        if (create($connection, "EQUIPE", $val_cols) !== false) {
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body col-lg-offset-3">
                            ...
                            <form action="nvequipe.php" method="post">

                                <div class="col-md-6">

                                    <div class="form-group">
                                        <input type="text" name="nom" class="form-control" required="" placeholder="Nom d'équipe" />
                                    </div>
